...
-- =============================================
create PROCEDURE [dbo].[ElencoMenuGruppi2] 
	@IdUtente int
...
AS
	...
	select me.idmenuelemento 
		...
		left join ruoli mr on mr.idruolo=lnk.idruolo and mr.idruolo=30
	...
	update #tmp set Attivato=1 
		...
		inner join UTENTI u on u.IdUtente=ug.IdUtente and u.IdUtente=2
	where 1=1
