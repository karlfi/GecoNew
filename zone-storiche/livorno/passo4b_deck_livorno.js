...
const FR = "C:/Users/Carlo/AppData/Local/Temp/claude/C--progetti-AI-TWEB/53fa87f8-62f2-4876-98a8-b6325d6172f6/scratchpad/frames_li/";
...
s.addText("Filiale Livorno — dai punti di consegna NEXIVE alle aree dei driver", {
  x: 0.9, y: 3.45, w: 11.5, h: 0.6, fontSize: 22, color: ICE, fontFace: "Calibri", margin: 0,
});
s.addText("novembre 2019 – marzo 2020  ·  195.430 consegne geolocalizzate  ·  113 giorni  ·  22 postini", {
...
slideMappa("f5_periodo", "LA PROGRESSIONE — 5 / 5", "Tutto il periodo", [
  { big: "122.767", label: "punti geolocalizzati · nov 2019 – mar 2020" },
  { testo: "Cinque mesi di storia. Altre 72.478 consegne senza geolocalizzazione puntuale sono escluse dal calcolo.", h: 0.9 },
], true);

slideMappa("f6_zone_passo1", "PASSO 1", "Le 12 zone storiche", [
  { big: "12", label: "zone · bilanciate sul carico e contigue" },
  { big: "73,5%", label: "coerenza: quota di punti del driver dominante di zona nel giorno" },
  { testo: "Zone cittadine da 42 a 130 punti/giorno: in città i postini ruotano più che nei territori estesi.", h: 1.0 },
]);
slideMappa("f7_aree_finali", "PASSI 2 e 3", "Un'area unica per giro", [
  { big: "12+1", label: "poligoni: 12 giri sul comune di Livorno + Isola di Capraia dedicata" },
  { big: "100%", label: "del comune attribuito: ogni consegna futura cade in un giro preciso" },
  { testo: "Il 99,95% delle consegne storiche è nel comune di Livorno: il territorio dei giri è il comune, non la provincia. Shape pronti per GEO_GIRI.", h: 1.1 },
]);
...
const passi = [
  ["1", "Conferma delle zone", "le 12 aree cittadine + Capraia sono in attesa di approvazione"],
  ["2", "Memorizzazione", "shape in GEO_GIRI della filiale 29 con prefisso LI2020- (script pronto)"],
  ["3", "Replica", "prossime filiali: Prato, Siena, Empoli, Portoferraio…"],
];
passi.forEach((p, i) => {
  const y = 2.2 + i * 1.5;
...
pres.writeFile({ fileName: "C:/progetti/AI/TWEB/zone-storiche/livorno/zone-livorno.pptx" })
